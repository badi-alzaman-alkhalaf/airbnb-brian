...
from property.models import Property, PropertyReservation, PropertyRate
from property.forms import PropertyReservationForm
...
def my_reservation(request):
    user_reservation = PropertyReservation.objects.filter(name=request.user)
...
#     try:
#         user_feedback = get_object_or_404(PropertyRate , property=property , author=request.user)
#         if request.method == 'POST':
